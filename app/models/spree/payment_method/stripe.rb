module Spree
  class PaymentMethod::Stripe < SolidusStripe.payment_method_parent_class
    ...
    def credit(money, creditcard, response_code, _transaction_options)
      gateway.refund(money, response_code, {})
    end

    def void(response_code, creditcard, _transaction_options)
